...
static ERRLIST elErrors[] =
{
    ...
    { DDERR_DESTCLRKEYNOTSET, "DDERR_DESTCLRKEYNOTSET" },
    { DDERR_EXCLUSIVEMODENOTOWNED, "DDERR_EXCLUSIVEMODENOTOWNED" },
    { DDERR_EXCLUSIVEMODEUNAVAILABLE, "DDERR_EXCLUSIVEMODEUNAVAILABLE" },
    ...
    { DDERR_INVALIDDRIVER, "DDERR_INVALIDDRIVER" },
    { DDERR_INVALIDMODE, "DDERR_INVALIDMODE" },
    { DDERR_INVALIDPALETTE, "DDERR_INVALIDPALETTE" },
    ...
    { DDERR_NOROTATEHW, "DDERR_NOROTATEHW" },
    { DDERR_NOSRCCLRKEYHW, "DDERR_NOSRCCLRKEYHW" },
    ...
    { DDERR_OVERLAYCLRKEYONLYONEACTIVE, "DDERR_OVERLAYCLRKEYONLYONEACTIVE" },
    { DDERR_PALETTEBUSY, "DDERR_PALETTEBUSY" },
    { DDERR_PRIMARYDOESNOTMATCH, "DDERR_PRIMARYDOESNOTMATCH" },
    { DDERR_SRCCLRKEYNOTSET, "DDERR_SRCCLRKEYNOTSET" },
    ...
    { DDERR_UNSUPPORTEDVERSION, "DDERR_UNSUPPORTEDVERSION" },
    { DDERR_WASSTILLDRAWING, "DDERR_WASSTILLDRAWING" },
    { DDERR_WIDTHALIGN, "DDERR_WIDTHALIGN" },
    { DDERR_XALIGN, "DDERR_XALIGN" },
    { DDERR_XYALIGN, "DDERR_XYALIGN" },
    { DDERR_YALIGN, "DDERR_YALIGN" }
};
